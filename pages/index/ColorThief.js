...
class CanvasImage {
  constructor(image) {
    this.context = wx.createCanvasContext('canvasPlaceholder')
...
export default class ColorThief {
  ...
  * */
  getColor(sourceImage, quality) {
    return this.getPalette(sourceImage, 5, quality).then((palette) => {
      return palette[0]
    })
  }
  ...
  */
  getPalette(sourceImage, colorCount, quality) {
    ...
    return image.getImageData().then(imageData => {

...
__DEFINE__(1537866293722, function(require, module, exports) {
"use strict";
...
//warning --- wechat bug ?
    if (lists[key] instanceof Object) {
      var warning_listsKey = Object.keys(lists[key]).map(function(k) {
        return lists[key][k]
      })
    }
  
    results[key] = warning_listsKey
      .map (function(name) {
...
}, function(modId) {var map = {"./lib/colors/basic":1537866293723,"./lib/colors/html":1537866293724,"./lib/colors/ntc":1537866293725,"./lib/colors/pantone":1537866293726,"./lib/colors/roygbiv":1537866293727,"./lib/colors/x11":1537866293728}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1537866293723, function(require, module, exports) {
module.exports = [
  { name: '黑色', hex: '#000000' },
  { name: '蓝色', hex: '#0000FF' },
  { name: '青色', hex: '#00FFFF' },
...
__DEFINE__(1537866293724, function(require, module, exports) {
module.exports = [
  { name: '浅绿色', hex: '#00FFFF' },
  { name: '艾莉斯蓝', hex: '#F0F8FF' },
  { name: '古董白色', hex: '#FAEBD7' },
  { name: '黑色', hex: '#000000' },
  { name: '蓝色', hex: '#0000FF' },
  { name: '青色色', hex: '#00FFFF' },
  { name: '深蓝色', hex: '#00008B' },
  ...
  { name: '黑蓝色', hex: '#191970' },
  { name: '宝蓝色', hex: '#1E90FF' },
  { name: '海藻绿色', hex: '#20B2AA' },
  { name: '森林绿色', hex: '#228B22' },
  { name: '海绿色', hex: '#2E8B57' },
  { name: '深青灰色', hex: '#2F4F4F' },
  { name: '暗瓦灰色', hex: '#2F4F4F' },
  { name: '暗绿色', hex: '#32CD32' },
  { name: '暗海藻色', hex: '#3CB371' },
  { name: '松绿色', hex: '#40E0D0' },
  { name: '宝蓝色', hex: '#4169E1' },
  { name: '钢青色', hex: '#4682B4' },
  { name: '深青蓝色', hex: '#483D8B' },
  { name: '粉蓝色', hex: '#48D1CC' },
  { name: '靛青色', hex: '#4B0082' },
  { name: '深橄榄绿', hex: '#556B2F' },
  { name: '藏青色', hex: '#5F9EA0' },
  { name: '菊蓝色', hex: '#6495ED' },
  { name: '草绿色', hex: '#66CDAA' },
  { name: '暗灰色', hex: '#696969' },
  { name: '青蓝色', hex: '#6A5ACD' },
  { name: '淡绿褐色', hex: '#6B8E23' },
  { name: '青灰色', hex: '#708090' },
  { name: '瓦灰色', hex: '#708090' },
  { name: '青灰色', hex: '#778899' },
  { name: '亮灰色', hex: '#778899' },
  ...
  { name: '天蓝色', hex: '#87CEFA' },
  { name: '天蓝色', hex: '#87CEEB' },
  { name: '紫罗兰色', hex: '#8A2BE2' },
  { name: '深洋红', hex: '#8B008B' },
  { name: '深红色', hex: '#8B0000' },
  { name: '重褐色', hex: '#8B4513' },
  { name: '暗海蓝色', hex: '#8FBC8F' },
  { name: '浅绿色', hex: '#90EE90' },
  { name: '暗紫色', hex: '#9370DB' },
  { name: '深紫色', hex: '#9400D3' },
  { name: '浅绿色', hex: '#98FB98' },
  { name: '深兰花紫', hex: '#9932CC' },
  { name: '黄绿色', hex: '#9ACD32' },
  { name: '赭色', hex: '#A0522D' },
  { name: '棕色', hex: '#A52A2A' },
  { name: '深灰色', hex: '#A9A9A9' },
  ...
  { name: '黄绿色', hex: '#ADFF2F' },
  { name: '浅蓝色', hex: '#ADD8E6' },
  { name: '淡蓝绿色', hex: '#AFEEEE' },
  { name: '浅钢蓝', hex: '#B0C4DE' },
  { name: '粉蓝色', hex: '#B0E0E6' },
  { name: '火砖色', hex: '#B22222' },
  { name: '深金黄色', hex: '#B8860B' },
  { name: '暗兰花色', hex: '#BA55D3' },
  { name: '玫瑰褐色', hex: '#BC8F8F' },
  { name: '深卡其色', hex: '#BDB76B' },
  { name: '银色', hex: '#C0C0C0' },
  { name: '暗紫色', hex: '#C71585' },
  { name: '印第安红', hex: '#CD5C5C' },
  { name: '秘鲁色', hex: '#CD853F' },
  ...
  { name: '黄花色', hex: '#DAA520' },
  { name: '兰花色', hex: '#DA70D6' },
  { name: '浅紫红色', hex: '#DB7093' },
  { name: '赤红色', hex: '#DC143C' },
  { name: '亮灰色', hex: '#DCDCDC' },
  { name: '梅色', hex: '#DDA0DD' },
  { name: '原木色', hex: '#DEB887' },
  { name: '浅青绿色', hex: '#E0FFFF' },
  { name: '淡紫色', hex: '#E6E6FA' },
  { name: '暗肉色', hex: '#E9967A' },
  { name: '淡金黄色', hex: '#EEE8AA' },
  { name: '紫色', hex: '#EE82EE' },
  { name: '天蓝色', hex: '#F0FFFF' },
  { name: '蜜色', hex: '#F0FFF0' },
  { name: '黄褐色', hex: '#F0E68C' },
  { name: '浅珊瑚红', hex: '#F08080' },
  { name: '黄褐色', hex: '#F4A460' },
  { name: '米色', hex: '#F5F5DC' },
  { name: '薄荷乳白', hex: '#F5FFFA' },
  { name: '小麦色', hex: '#F5DEB3' },
  { name: '烟白', hex: '#F5F5F5' },
  { name: '鬼白', hex: '#F8F8FF' },
  { name: '浅金色', hex: '#FAFAD2' },
  ...
  { name: '淡紫色', hex: '#FFF0F5' },
  { name: '粉黄色', hex: '#FFFACD' },
  { name: '浅粉红色', hex: '#FFB6C1' },
  { name: '橙红色', hex: '#FFA07A' },
  { name: '浅黄色', hex: '#FFFFE0' },
  { name: '品红色', hex: '#FF00FF' },
  { name: '粉玫瑰红色', hex: '#FFE4E1' },
  { name: '鹿皮色', hex: '#FFE4B5' },
  { name: '纳瓦白色', hex: '#FFDEAD' },
  { name: '橙色', hex: '#FFA500' },
  { name: '橙红色', hex: '#FF4500' },
  { name: '粉木瓜橙色', hex: '#FFEFD5' },
  { name: '粉桃红色', hex: '#FFDAB9' },
  { name: '粉色', hex: '#FFC0CB' },
  { name: '红色', hex: '#FF0000' },
  { name: '贝壳色', hex: '#FFF5EE' },
  { name: '雪白色', hex: '#FFFAFA' },
...
__DEFINE__(1537866293725, function(require, module, exports) {
module.exports = [
  {
    "name": "Black",
    "hex": "000000"
...
__DEFINE__(1537866293726, function(require, module, exports) {
module.exports = [{
  "name": "Mahogany",
  "hex": "#CD4A4A"
},{
...
__DEFINE__(1537866293727, function(require, module, exports) {
module.exports = [
  { name: 'red', hex: '#FF0000' },
...
__DEFINE__(1537866293728, function(require, module, exports) {
module.exports = [{
  name: 'indigo',
  hex: '#4b0082'
}, {
...
return __REQUIRE__(1537866293722);
})()
